    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <FirebaseClientProvider>
         ...
         <div
          aria-hidden="true"
          className="absolute inset-x-0 bottom-[-20rem] -z-10 transform-gpu overflow-hidden blur-3xl"
        >
          <div
            style={{
              clipPath:
            ...
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#80ff9a] to-[#89a2fc] opacity-20"
          />
        </div>
      </body>
    </html>
